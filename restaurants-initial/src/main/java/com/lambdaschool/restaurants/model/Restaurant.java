...
public class Restaurant extends Auditable
{
    ...
    @ApiModelProperty(name = "name", value = "Restaurant name", required = true, example = "Apple")
    @Column(unique = true,
            nullable = false)
    private String name;
    ...
    @Pattern(regexp = "\\d{3}-\\d{3}-\\d{4}", message = "555-555-5555")
    private String telephone;

    @Email(message = "Email should be valid email@domain.toplevel")
